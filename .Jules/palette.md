...
**Learning:** Default Astro blog templates often lack explicit visual feedback for link hover states (e.g., `a:hover` colors identically match the base `a` color). This reduces interactivity feedback for sighted users.
