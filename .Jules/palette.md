...
## 2026-08-05 - [Visual Feedback for Link Hover States]
**Learning:** Default Astro blog templates often lack explicit visual feedback for link hover states (e.g., `a:hover` colors identically match `a`), leaving users without immediate visual confirmation when interacting with elements.
