...
## 2026-08-28 - [Missing Hover States on Astro Links]
**Learning:** Default Astro blog templates often lack explicit visual feedback for link hover states (e.g., `a:hover` colors identically match `a`). This makes the navigation and content links feel unresponsive.
**Action:** Always explicitly verify and apply distinct hover styles and transitions (e.g., using a darker accent color or changing the border color) to interactive elements like global links and header navigation to improve UX.
