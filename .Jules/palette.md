...
## 2026-09-02 - Missing distinct link hover states in Astro templates
**Learning:** Default Astro blog templates often lack explicit visual feedback for link hover states (e.g., `a:hover` colors identically match `a` without transition). This makes it harder for users to identify interactive elements, negatively impacting usability.
